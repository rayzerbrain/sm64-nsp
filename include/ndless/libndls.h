...
#define NDLESS_DIR                                                                                     \
    ({ "NDLESS_DIR got removed. Use get_documents_dir() to get the virtual root first." })
...
int show_1numeric_input(const char *title, const char *subtitle, const char *msg, int *value_ref,
                        int min_value, int max_value);
int show_2numeric_input(const char *title, const char *subtitle, const char *msg1, int *value1_ref,
                        int min_value1, int max_value1, const char *msg2, int *value2_ref,
                        int min_value2, int max_value2);
...
#define show_msgbox_3b(title, msg, button1, button2, button3)                                          \
    _show_msgbox(title, msg, 3, button1, button2, button3)
