...
#define __GMP_CC "nspire-gcc"
#define __GMP_CFLAGS "-ffast-math -Og -I include -I build/us_nsp -I build/us_nsp/include -I src -I . -I lib/gmp -D_LANGUAGE_C -DVERSION_US -DNON_MATCHING -DAVOID_UB -DTARGET_NSP -DPERFECT_ASPECT -Wfatal-errors -DNO_SEGMENTED_MEMORY  -DENABLE_SOFTRAST -DF3DEX_GBI_2 -fno-strict-aliasing -fwrapv "
